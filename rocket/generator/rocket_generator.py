...
class Generator:
    ...
    def generate_dir(self):
        ...
        self.src_common_path = self.src_path + '/common'
        ...
        dir_list.append(self.src_common_path) 
    ...
    def gen_include_name(self):
        ...
        self.INCLUDE_BUSINESS_EXCEPTION_HEADER = '#include "' + self.project_name + '/common/business_exception.h"'
    ...
    def gen_exception(self):
        ...
        exception_file = self.src_common_path + '/business_exception.h'
    ...
    def generate_framework_code(self): 
        print('=' * 100)
        print('Begin to generate rocket framework code')
    ...
    def gen_conf_file(self):
        print('=' * 100)
        print('Begin to generate rocket conf file')
    ...
    def generate_rocket_project(self):
        try:

            self.parseInput()

            print('=' * 150)
            print('Begin generate rocket project')
            ...
            print('Falied generate rocket project, err:')
            print(e)
            traceback.print_exc()
            print('=' * 150)
        finally:
...
if __name__ == '__main__':
    instanse = Generator()
    instanse.generate_rocket_project()