...
namespace rocket {
    ...
    #define DEBUGLOG(str, ...) \
            ...
            { \
            rocket::Logger::GetGobalLogger()->pushLog((new rocket::LogEvent(rocket::LogLevel::Debug))->toString() \
    ...
    #define INFOLOG(str, ...) \
        ...
        { \
        rocket::Logger::GetGobalLogger()->pushLog((new rocket::LogEvent(rocket::LogLevel::Info))->toString() \
        + "[" + std::string(__FILE__) + ":" + std::to_string(__LINE__) + "]\t" + rocket::formatString(str, ##__VA_ARGS__) + '\n'); \
        rocket::Logger::GetGobalLogger()->log(); \
        } \
    ...
    #define ERRORLOG(str, ...) \
        ...
        { \
        rocket::Logger::GetGobalLogger()->pushLog((new rocket::LogEvent(rocket::LogLevel::Error))->toString() \
        + "[" + std::string(__FILE__) + ":" + std::to_string(__LINE__) + "]\t" + rocket::formatString(str, ##__VA_ARGS__) + '\n'); \
        rocket::Logger::GetGobalLogger()->log(); \
        } \
